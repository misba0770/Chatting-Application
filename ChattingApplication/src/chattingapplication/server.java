...
public class server  implements ActionListener{
    ...
    server(){
        ...
        ImageIcon i4=new ImageIcon(ClassLoader.getSystemResource("chattingapplication/icons/bhupinder.jpg"));
        ...
        JLabel l3=new JLabel("Bhupinder");
